...
class Tokenizer:
    ...
    def __init__(self, vocab_path: str = f"{VOCAB_DIR}/vocab.txt") -> None:
        self.vocab_dict = {
    ...
    def generate_vocab(cls, dataset_path: str):
        ...
        with open(f"{VOCAB_DIR}/vocab.txt", "w", encoding="utf-8") as f:
            for v in vocab_counter:
                f.write(v + "\n")


if __name__ == "__main__":
    Tokenizer.generate_vocab("dataset/")
    tokenizer = Tokenizer(f"{VOCAB_DIR}/vocab.txt")
